...
class HtmlCollector(HtmlCollectorInterface):
    ...
    def collect_information(self, html: str):
        ...
        stocks_information_data = stocks_information.find_all('span', {'class': 'txt'})
        ...
        oscilacoes_indicators_data = fundamentalist_indicators.find_all('span', {'class': 'oscil'})
        ...
        fundamental_indicators_data = fundamentalist_indicators.find_all('span', {'class': 'txt'})
        ...
        demonstrative_results_data = demonstrative_results.find_all('span', {'class': 'txt'})
        # Últimos 12 meses.
